...
<div class="produk-user container-fluid py-3 px-5 bg-warning-subtle pt-5" id="Product">
            ...
            <div class="card produk text-bg-dark">
                ...
                <div class="card-img-overlay">
                    <div class="isi-card">
                        ...
                        <p class="card-text"><a href="{{ route('kategori.paket',$kategoriproduk->id) }}" class="btn btn-warning  text-white"><strong>Cari Tau
                                    Yuk</strong></a></p>
                    </div>
                </div>
            </div>
  ...
  @endforeach
                    ...
                    <div class="row">
                        @foreach($chunk as $item)
                            <div class="penerbit-item col-lg-2 mb-2">
                                <a href="{{ route('paket.penerbit',$item->id) }}">
            ...
            <div class="card produk text-bg-dark">
                ...
                <div class="overlay-produk card-img-overlay">
                    <div class="isi-card">
                        ...
                        <p class="card-text"><a class="btn btn-outline-warning text-white" href="{{ route('produk.all') }}"><strong>SELENGKAPNYA</strong> <i class="fa-solid fa-circle-arrow-right"></i></a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="d-flex justify-content-center mt-3">
        <a class="btn btn-dark btn-lg rounded-5 d-flex align-items-center gap-2" href="{{ route('produk.all') }}"><strong class="fw-bold">SELENGKAPNYA</strong><i class="fa-solid fa-circle-arrow-right"></i></a>
    </div>


</div>
<div class="about-user container-fluid py-3 px-5 bg-dark pt-5 pb-5" id="About">
