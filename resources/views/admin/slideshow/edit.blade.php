...
@section('konten-admin')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 fw-bold"><strong>Edit Slide Show</strong></h1>
    </div>

    <div class="card mb-4 bg-warning-subtle border-start border-black border-3">
        <div class="card-body">
            <form action="{{ route('update.slideshow',$data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="row mb-3 fw-bold">
                    <div class="col-md-12">
                        ...
                        placeholder="Kata dalam Tombol" value="{{ $data->button }}">
                    @error('button')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                    </div>
                ...
                <div class="row mb-3 fw-bold">
                    <div class="col-md-6">
                        <label for="inputIcon" class="form-label">Icon <small>silahkan upload icon jika ingin merubah icon SlideShow</small></label><br>
                    ...
                    <div class="col-md-6">
                        <label for="inputGambar" class="form-label">Gambar <small>silahkan upload gambar jika ingin merubah gambar SlideShow</small></label><br>
