...
@section('konten-admin')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 fw-bold"><strong>Tambah Paket</strong></h1>
    </div>
        ...
        <div class="card-body">
            <form action="{{ route('simpan.paket') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3 fw-bold">
                    ...
                    <div class="col-md-6">
                        <label for="inputFoto" class="form-label">Gambar</label><br>
                ...
                <div class="row fw-bold">
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="inputHarga" name="harga_paket" class="form-control" value="{{ old('harga_paket') }}" >
