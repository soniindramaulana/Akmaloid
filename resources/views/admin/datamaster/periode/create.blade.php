...
@section('konten-admin')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 fw-bold"><strong>Tambah Periode</strong></h1>
    </div>


    <div class="card mb-4 bg-warning-subtle border-start border-black border-3">
        <div class="card-body">
            <form action="{{ route('simpan.periode') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3 fw-bold">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="InputPeriode" name="periode"
                            placeholder="Periode Paket" value="{{ old('periode') }}">
                        @error('periode')
