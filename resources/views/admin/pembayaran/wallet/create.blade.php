...
@section('konten-admin')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 fw-bold"><strong>Tambah Wallet</strong></h1>
    </div>

    <div class="card mb-4 bg-warning-subtle border-start border-black border-3">
        <div class="card-body">
            <form action="{{ route('simpan.wallet') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3 fw-bold">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="InputEWallet" name="e_wallet"
                            placeholder="E-Wallet" value="{{ old('e_wallet') }}">
                        @error('e_wallet')
                ...
                <div class="row mb-3 fw-bold">
                    <div class="col-md-6">
                        ...
                        placeholder="Nomer Rekening" value="{{ old('no_rek') }}">
                        @error('no_rek')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
