...
class KategoriProdukDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (KategoriProduk $data) {
                return view('admin.datamaster.kategoriproduk.action', compact('data'));
            })
            ->editColumn('foto', function (KategoriProduk $data)  {
